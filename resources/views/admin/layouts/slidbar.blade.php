    ...
    <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{ route('admin.type-properties.index') }}">Type Properties</a>
                <a class="collapse-item" href="{{ route('admin.list-views.index') }}">List Views</a>
                <a class="collapse-item" href="{{ route('admin.type-finishes.index') }}">Type Finishes</a>
            </div>
        </div>
    </li>
