    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addModalLabel">Type Finish Form</h5>
            ...
            <div class="modal-body">
                <form id="adminForm">
                    @csrf
                    <input type="hidden" name="finish_type_id" id="finish_type_id" value="">
                    <div class="row">
                        <x-language-input label="Finish Type Name" name="name" id="finishTypeName" />
                    </div>
                </form>
            </div>
