...
trait GeneralApiTreat
{
     ...
     */
    public function responseError($errorNum, $msg){
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function responseSuccess($successNum,$msg){
        return response()->json([
           'status'=> true,
    ...
    public function responseWithData($key,$value,$msg='success send data'){
        return response()->json([
           'status'=>true,
           'errNum'=>'',
           'message'=> $msg,
    ...
    {
        return $this->responseError($code, $validator->errors()->first());
    }
